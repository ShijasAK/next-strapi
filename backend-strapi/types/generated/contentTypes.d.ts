...
export interface ApiBlogPageBlogPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    listOfBlogs: Attribute.Component<'blocks.blog-tiles', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDetailedBlogPageDetailedBlogPage extends Schema.SingleType {
  collectionName: 'detailed_blog_pages';
  info: {
    singularName: 'detailed-blog-page';
    pluralName: 'detailed-blog-pages';
    displayName: 'Detailed Blog page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    content: Attribute.DynamicZone<['section.detailed-blog-information']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    homePageComponents: Attribute.DynamicZone<
      [
        'blocks.about-us',
        'section.ai',
        'blocks.fav-app',
...
export interface ApiServiceService extends Schema.SingleType {
  ...
  attributes: {
    service: Attribute.DynamicZone<['blocks.about-us']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::detailed-blog-page.detailed-blog-page': ApiDetailedBlogPageDetailedBlogPage;
